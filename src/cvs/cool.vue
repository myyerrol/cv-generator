    ...
    <div class="content">
      ...
      <div class="content__right">
        ...
        <div
          ...
          <div class="section-content-grid cv-list-column cv-list-indent">
            <a v-for="(project, index) in person.projects" :key="index"
              class="section-content__item-grid cv-list"
        ...
        <div
          ...
          <div class="section-content-grid cv-list-indent">
            <a
...
.banner {
  ...
  /*
    background-image: url('../../cv/banner.png');
